...
from transformers_utils import elapsed_time, amp_callback_opt, batch_generate_texts
...
def parse_args():
    ...
    parser.add_argument("--model_id", type=str, default="facebook/opt-13b")
...
def save_splited_model(args):
    hf_model = OPTForCausalLM.from_pretrained(args.model_id, low_cpu_mem_usage=True)
    amp_callback_opt(hf_model, torch.float16)
...
def get_neuron_model(args):
    ...
    neuron_model = OPTForSampling.from_pretrained(
        args.save_path, 
